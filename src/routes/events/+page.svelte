...
<div class="my-20 ">
    ...
    <p class="text-lg text-neutral-400 hidden">No future events planned at the moment!</p>
    <div class="grid grid-cols-2 gap-10 pt-10">
        <div class="flex space-x-4">
            <div>
                ...
                <p class="font-semibold text-cyan-200">{`March 2025 - Toronto, ON`}</p>
                <p>
                    Furnal Equinox is an annual furry convention held in Toronto, Ontario, Canada. It is one of the largest events of its kind in the country, bringing together enthusiasts of anthropomorphic art, characters, and culture.
                </p>
                <div class="flex space-x-2 mt-3">
                    ...
                    href="https://lynix.ca"
                    target="_blank"
                    class="h-10 px-4 hidden bg-green-500 text-green-950 text-lg font-bold py-1.5 rounded-2xl"
                    >Planned</a
                >
                <a
                href="https://lynix.ca"
                target="_blank"
                class="h-10 px-4 bg-red-500 text-red-950 text-lg font-bold py-1.5 rounded-2xl"
                >Cancelled</a
            >
                </div>
            </div>
        ...
        <div class="flex space-x-4">
            <div>
                ...
                <p class="font-semibold text-cyan-200">{`May 8 2025 - Atlanta, Georgia`}</p>
                <p>
                    FWA is dedicated to the interests and activities of the furry fandom, a subculture focused on anthropomorphic animals, which are animals with human characteristics. FWA is one of the larger furry conventions in the United States.
                </p>
                <div class="flex space-x-2 mt-3">
                    <a
                        href="https://lynix.ca"
        ...
        <div class="flex space-x-4">
            <div>
                ...
                <p class="font-semibold text-cyan-200">{`July 2025 - Pittsburgh, Pennsylvania`}</p>
                <p>
                    Anthrocon is one of the largest and most well-known furry conventions in the world. It takes place annually in Pittsburgh, Pennsylvania, usually in late June or early July.
                </p>
                <div class="flex space-x-2 mt-3">
                    <a
                        href="https://lynix.ca"
            ...
            <img
                src="https://media.furrycon.social/accounts/avatars/109/430/793/271/029/131/original/5a536ff7454ae6ff.png"
                alt="Lynix"
                class="rounded-xl w-32 h-32 border-2 bg-neutral-900 border-neutral-800 p-3 object-fit"
            />
        </div>
    </div>
</div>