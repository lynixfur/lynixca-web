...
>
    ...
    >
        ...
        <div class="flex space-x-5 items-center">
            <img
                class="w-[350px]"
                src="/BadgeWarning.png"
                alt="How to read my badge"
            />
            <p
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 pt-10">
        ...
        <div class="flex space-x-4">
            <div>
                ...
                <p class="font-semibold text-cyan-200">
                    {`June 6 - 9, 2024 - VRChat`}
                </p>
                <p>
                    Furality is the largest annual virtual furry convention held
                    on VRChat. It offers a range of activities including panels,
                    social meetups, art showcases, and virtual world
