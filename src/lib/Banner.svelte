<script lang="ts">
  ...
  <div class="hidden bg-cyan-900 py-2 px-5 max-w-[800px] md:rounded-full rounded-xl font-semibold -ml-1 md:mt-0 mt-10">
	  Lynix is going to Animaritime in {daysUntilToronto} days! Watch out for a Lynix sticker, 1 left!
  </div>

  <div class="hidden bg-red-900 py-2 px-5 max-w-[800px] md:rounded-full rounded-xl font-semibold -ml-1 md:mt-5 mt-10">
